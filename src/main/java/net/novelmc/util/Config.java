...
public class Config
{
    ...
    {
        configFile.put(configfile, new File(Bukkit.getServer().getPluginManager().getPlugin("Converse").getDataFolder(), configfile.getFile()));
        ...
        else
        {
            try
            {
                Bukkit.getServer().getPluginManager().getPlugin("Converse").getDataFolder().mkdir();
